	...
	public class LeanTranslate : MonoBehaviour
	{
		...
		protected virtual void Translate(Vector2 screenDelta)
		{
			...
			if (camera != null)
			{
                ...
                //mine
                transform.position = new Vector3 (transform.position.x, transform.position.y, GetClickedObject.yPreventer.transform.position.z);
                //mine
                ...
                //mine
                //transform.position = new Vector3(transform.position.x, transform.position.y, GetClickedObject.LastClickedPosition.z);
